...
PHOTO_SAVE_DIR = "training/captured" # base dir is where you run the script
                                     # for example you run the script by:
                                     # `python training/data_collector_v2.py`
                                     # then the photos will be saved in `training/captured`
